...
const AddWorkshop = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      await api.post(`/workshops`, formDataToSend, {
        headers: {
  ...
  const renderFormFields = () => {
    const fields = [
      ...
      { label: "Photo", name: "thumbnail", type: "file" }, // Change to file input
    ];
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-md">
      <h2 className="text-xl font-semibold mb-4">Add Workshop</h2>
