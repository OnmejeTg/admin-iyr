...
const Workshop = () => {
  ...
  const handleMentorClick = (mentor) => {
    navigate(`/opportunities/workshops/${mentor._id}`);
  };

  return (
    <div>
      <h2 className="text-lg font-semibold">Select Workshop to change</h2>
      ...
      <div className="mt-4 flex justify-end">
        <button
          ...
          onClick={() => navigate("/opportunities/workshops/add")}
        >
          Add Workshop
        </button>
      </div>
