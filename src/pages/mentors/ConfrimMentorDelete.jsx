...
const ConfrimMentorDelete = () => {
  ...
  const handleFundlingClick = (id) => {
    navigate(`/opportunities/mentors/${id}`);
  };
    ...
    <div>
      ...
      <div className="pt-6">
        ...
        <button
          ...
          onClick={() => navigate(`/opportunities/mentors/${funding._id}`)}
        >
          Cancel
        </button>
      </div>
...
export default ConfrimMentorDelete;
